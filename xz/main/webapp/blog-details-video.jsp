                ...
                <div class="row">
                    <div class="col-12 text-center">
                        ...
                        <%--<ul class="breadcrumb justify-content-center">
                            ...
                            <li class="current"><a href="blog-details-video.jsp">Video Blog Details</a></li>
                        </ul>--%>
                    </div>
                </div>
            </div>
                                    ...
                                    <div class="post-info">
                                        ...
                                        <div class="social__sharing mb--30">
                                            ...
                                            <ul class="social social-round">
                                                <li class="social__item">
                                                    <a href="https://www.facebook.com/" target="_blank" class="social__link"><i class="fa fa-facebook"></i></a>
                                                </li>
                                                <li class="social__item">
                                                    <a href="https://www.twitter.com/" target="_blank" class="social__link"><i class="fa fa-twitter"></i></a>
                                                </li>
                                                <li class="social__item">
                                                    <a href="https://www.pinterest.com/" target="_blank" class="social__link"><i class="fa fa-pinterest"></i></a>
                                                </li>
                                                <li class="social__item">
                                                    <a href="https://www.google.com/" target="_blank" class="social__link"><i class="fa fa-google-plus"></i></a>
                                                </li>
                                                <li class="social__item">
                                                    <a href="https://www.linkedin.com/" target="_blank" class="social__link"><i class="fa fa-linkedin"></i></a>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-4 mb-md--30">
                                                <div class="related-post">
                                                    <a href="blog-details-image.jsp" class="related-post__thumb">
                                            ...
                                            <div class="col-lg-4 mb-md--30">
                                                <div class="related-post">
                                                    ...
                                                    <h4><a href="blog-details-image.jsp">TAKE A RIDE IN A LUXURY CAR</a></h4>
