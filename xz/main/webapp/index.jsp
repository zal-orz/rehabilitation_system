    ...
    <div class="wrapper bg--shaft">
                                    ...
                                    <div class="user-info header-top-nav__item">
                                        <div class="dropdown header-top__dropdown">
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="userID">
                                                ...
                                                &lt;%&ndash;<input type="button" class="dropdown-item" value="Log Out">&ndash;%&gt;
                                            </div>
                                        </div>
                                    </div>
                                </c:if>
        ...
        <div class="main-content-wrapper">
                                ...
                                <div class="col-12">
                                    <div class="slider-content">
                                        ...
                                        <div class="slide-btn-group" data-animation="fadeInUp" data-duration="1s" data-delay=".3s">
                                            <c:if test="${sessionScope.name == null}">
                                                <a onclick="nonLoginAlert()" class="btn btn-bordered btn-style-1">Shop Now</a>
                                            </c:if>
                                            <c:if test="${sessionScope.name != null}">
                                                <a href="ShopServlet" class="btn btn-bordered btn-style-1">Shop Now</a>
                                            </c:if>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="slider-content">
                                        ...
                                        <div class="slide-btn-group" data-animation="fadeInUp" data-duration="1s" data-delay=".3s">
                                            <c:if test="${sessionScope.name == null}">
                                                <a onclick="nonLoginAlert()" href="" class="btn btn-bordered btn-style-1">Shop Now</a>
                                            </c:if>
                                            <c:if test="${sessionScope.name != null}">
                                                <a href="ShopServlet" class="btn btn-bordered btn-style-1">Shop Now</a>
                                            </c:if>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="slider-content">
                                        ...
                                        <div class="slide-btn-group" data-animation="fadeInUp" data-duration="1s" data-delay=".3s">
                                            <a href="shop.jsp" class="btn btn-bordered btn-style-1">Shop Now</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="promo-box-area border-bottom ptb--80 ptb-md--60">
                <div class="container">
                    <div class="row">
                        <div class="col-md-4 mb-sm--30" style="margin: 0 auto">
                            <div class="promo promo-1">
                                <c:if test="${sessionScope.name == null}">
                                    <a onclick="nonLoginAlert()" href="" class="promo__box">
                                ...
                                <c:if test="${sessionScope.name != null}">
                                    <a href="shop.jsp" class="promo__box">
                                        <img src="assets/img/banner/img1-top-mirora1.jpg" alt="Product Category"/>
                                        <span class="promo__content">
                                            <span class="promo__label">Design Creative</span>
                                            <span class="promo__name">Modern and Clean</span>
                            ...
                            <div class="tab-content product-tab__content" id="product-tabContent">
                                <div class="tab-pane fade show active" id="nav-featured" role="tabpanel">
                                    <div class="product-carousel js-product-carousel">
                                        <%
                                            WatchDataDao watchDataDao1 = new WatchDataDao();
                                            List<Watches> list1 = watchDataDao1.getall();
                                            list1 = list1.subList(0, 10);
                                            for (int i = 0; i < 5; i++){
                                                int index1 = 2 * i;
                                                int index2 = 2 * i + 1;
                                                Watches p1 = list1.get(index1);
                                                Watches p2 = list1.get(index2);
                                        %>
                                        <div class="product-carousel-group">
                                            <div class="mirora-product">
                                                <div class="product-img">
                                                    <img src="<%=p1.getPicOrig()%>" alt="Product" class="primary-image" />
                                                    <img src="<%=p1.getPicAfter()%>" alt="Product" class="secondary-image" />
                                                ...
                                                <div class="product-content text-center">
                                                    <span><%=p1.getBrand()%></span>
                                                    <c:if test="${sessionScope.name == null}">
                                                        <h4><a onclick="nonLoginAlert()" href=""><%=p1.getName()%></a></h4>
                                                    </c:if>
                                                    <c:if test="${sessionScope.name != null}">
                                                        <h4><a href="product-details.jsp?id=<%=p1.getId()%>"><%=p1.getName()%></a></h4>
                                                    </c:if>
                                                    <div class="product-price-wrapper">
                                                        <span class="money">$<%=p1.getPrice()%></span>
                                            ...
                                            <div class="mirora-product">
                                                <div class="product-img">
                                                    <img src="<%=p2.getPicOrig()%>" alt="Product" class="primary-image" />
                                                    <img src="<%=p2.getPicAfter()%>" alt="Product" class="secondary-image" />
                                                    <div class="product-img-overlay">
                                                        <%--<span class="product-label discount">
                                                            -7%
                                                        </span>
                                                ...
                                                <div class="product-content text-center">
                                                    <span><%=p2.getBrand()%></span>
                                                    <c:if test="${sessionScope.name == null}">
                                                        <h4><a onclick="nonLoginAlert()" href=""><%=p2.getName()%></a></h4>
                                                    </c:if>
                                                    <c:if test="${sessionScope.name != null}">
                                                        <h4><a href="product-details.jsp?id=<%=p2.getId()%>"><%=p2.getName()%></a></h4>
                                                    </c:if>
                                                    <div class="product-price-wrapper">
                                                        <span class="money">$<%=p2.getPrice()%></span>
                                                        <%--<span class="product-price-old">
                                                            <span class="money">$700.00</span>
                                                        </span>--%>
                                                    </div>
                                        ...
                                        <%--<div class="product-carousel-group">
                                            <div class="mirora-product">
                                                <div class="product-img">
                                                    ...
                                                    <div class="product-img-overlay">
                                                        &lt;%&ndash;<span class="product-label discount">
                                                            -7%
                                                        </span>
                                                        <a data-toggle="modal" data-target="#productModal" class="btn btn-transparent btn-fullwidth btn-medium btn-style-1">Quick View</a>&ndash;%&gt;
                                                    </div>
                                                </div>
                                                <div class="product-content text-center">
                                                    <span>Cartier</span>
                                                    <c:if test="${sessionScope.name == null}">
                                                        <h4><a onclick="nonLoginAlert()" href="">Acer Aspire E 17</a></h4>
                                                    </c:if>
                                                    <c:if test="${sessionScope.name != null}">
                                                        <h4><a href="product-details.jsp">Acer Aspire E 17</a></h4>
                                                    </c:if>
                                                    <div class="product-price-wrapper">
                                                        <span class="money">$550.00</span>
                                                        &lt;%&ndash;<span class="product-price-old">
                                                            <span class="money">$700.00</span>
                                                        </span>&ndash;%&gt;
                                                    </div>
                                                </div>
                                                <div class="mirora_product_action text-center position-absolute">
                                                    &lt;%&ndash;<div class="product-rating">
                                                        <span>
                                                            <i class="fa fa-star theme-star"></i>
                                                            <i class="fa fa-star theme-star"></i>
                                                            <i class="fa fa-star theme-star"></i>
                                                    ...
                                                    &lt;%&ndash;<div class="product-action">
                                                        <a class="same-action" href="wishlist.jsp" title="wishlist">
                                                            <i class="fa fa-heart-o"></i>
                                                        </a>
                                                        <a class="add_cart cart-item action-cart" href="cart.jsp" title="wishlist"><span>Add to cart</span></a>
                                ...
                                <div class="tab-pane fade" id="nav-new" role="tabpanel">
                                    <div class="product-carousel js-product-carousel">
                                        <%
                                            WatchDataDao watchDataDao2 = new WatchDataDao();
                                            List<Watches> list2 = watchDataDao2.getall();
                                            list2 = list2.subList(10, 20);
                                            for (int i = 0; i < 5; i++){
                                                int index1 = 2 * i;
                                                int index2 = 2 * i + 1;
                                                Watches p1 = list2.get(index1);
                                                Watches p2 = list2.get(index2);
                                        %>
                                        <div class="product-carousel-group">
                                            <div class="mirora-product">
                                                <div class="product-img">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="blog-carousel nav-top slick-item-gutter">
                                <article class="blog">
                                    <a href="blog-details-image.jsp" class="blog__thumb">
                                        <img src="assets/img/blog/post1-370x230.jpg" alt="Blog">
                                    </a>
                                    <div class="blog__content">
                                        <div class="blog__meta">
                                            <p class="blog__author">Post By: <a href="blog.jsp">HasTech</a></p>
                                            <p class="blog__date"><a href="blog.jsp">20 Oct 2018</a></p>
                                        </div>
                                        
                                        <h3 class="blog__title"><a href="blog-details-image.jsp">Mollis aliquet ante, suscipit non eget  nulla libero, vestibulum condimentum.</a></h3>
                                        <div class="blog__text">
                                            ...
                                            <a class="read-more" href="blog-details-image.jsp">Read More</a>
                                        </div>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-xl-9 col-lg-10">
                            <div class="newsletter text-center">
                                ...
                                <c:if test="${sessionScope.name == null}">
                                    <input type="submit" value="Subscribe" onclick="nonLoginAlert()" class="btn newsletter-btn btn-style-1">
                                </c:if>
                                <c:if test="${sessionScope.name != null}">
                                    <form class="newsletter-form validate mt--40" action="SubscribeServlet" method="post" id="mc-embedded-newsletter-form" target="sub_iframe" name="mc-embedded-newsletter-form" novalidate="">
                                        <input type="submit" value="Subscribe" class="btn newsletter-btn btn-style-1">
                                    </form>
                                </c:if>
                                <iframe id="id_iframe" name="sub_iframe" style="display:none;"></iframe>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="container-fluid p-0">
                    <div class="row no-gutters">
                        <div class="col-md-6 mb-sm--20">
                            <div class="promo">
                                <a href="shop.jsp" class="promo__box promo__box-2">
                    ...
                    <div class="col-lg-8 col-md-6 mb-md--30" style="margin: 0 auto; text-align: center">
                        <div class="footer-widget">
                            ...
                            <div class="widget-content mb--20">
                                ...
                                %>
                                <P>&copy;&nbsp;Page views are:&nbsp;<%=hitsCount%></P>
                            </div>
